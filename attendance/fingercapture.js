...
function onImageDownload(){
    if(currentFormat == Fingerprint.SampleFormat.PngImage){
        let smatric = $("#studmat").val();
        if(localStorage.getItem("imageSrc") == "" || localStorage.getItem("imageSrc") == null || document.getElementById('imagediv').innerHTML == "" ){
           alert("No fingerprint found");
        }else{
            //alert(localStorage.getItem("imageSrc"));
            //downloadURI(localStorage.getItem("imageSrc"), smatric+".png", "image/png");
            //var loadPath = "C:/xampp/htdocs/attendance/public/finger/"+smatric+".png";
            //downloadURI(localStorage.getItem("imageSrc"), smatric+".png", "./public/finger/");
